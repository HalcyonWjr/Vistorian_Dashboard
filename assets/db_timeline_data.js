const timeline_data = {
  ...
  "data": {
    ...
    "format":{
      "type": "json",
      "property": "timeline.dataFiltering"
    }
  },
    ...
    "encoding":{
      "y": {
        ...
        "axis":{"labelAlign":"left", "labelPadding":70, "ticks":false, "zindex": 1, "domainWidth":1.2, "domainColor":"black", "labelFontSize":12}},
  ...
  vegaEmbed("#timeline_data", timeline_data, {mode: "vega-lite", "actions":false}).then(console.log).catch(console.warn);
