const matrix_visual = {
  ...
  "data": {
    ...
    "encoding":{
      "y": {
        ...
        "axis":{"labelAlign":"left", "labelPadding":65, "ticks":false, "zindex": 1, "domainWidth":1.2, "domainColor":"black", "labelFontSize":12}},
  ...
  vegaEmbed("#matrix_visual", matrix_visual, {mode: "vega-lite", "actions":false}).then(console.log).catch(console.warn);